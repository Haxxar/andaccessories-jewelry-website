  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gray-50">
        <Head>
          <title>Vedhæng | &Accessories - Smukke Smykker Online</title>
          <meta name="description" content="Udforsk vores omfattende kollektion af vedhæng. Find elegante vedhæng, hjerte vedhæng og meget mere til de bedste priser." />
        </Head>
  ...
  return (
    <div className="min-h-screen bg-pink-100">
      <Head>
        <title>Vedhæng | &Accessories - Smukke Smykker Online</title>
        <meta name="description" content="Udforsk vores omfattende kollektion af vedhæng. Find elegante vedhæng, hjerte vedhæng og meget mere til de bedste priser." />
        <meta name="keywords" content="vedhæng, hjerte vedhæng, guld vedhæng, sølv vedhæng, smykker" />
      </Head>
      ...
      <section className="relative bg-gradient-to-r from-yellow-100 to-pink-100 py-16 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl md:text-6xl font-bold text-gray-800 mb-6">Vedhæng</h1>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto mb-8">
              Udforsk vores omfattende kollektion af vedhæng. Find elegante vedhæng, hjerte vedhæng og meget mere til de bedste priser.
            </p>
            ...
            <div className="mt-4 text-sm text-gray-600">
              Viser {products.length} af {pagination.totalCount} vedhæng
            </div>
          </div>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {products.length === 0 ? (
          <div className="text-center py-12">
            <h2 className="text-xl font-semibold text-gray-800 mb-2">Ingen vedhæng fundet</h2>
