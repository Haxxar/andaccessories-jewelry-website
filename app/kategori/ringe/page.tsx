...
const products = [
  {
    ...
    originalPrice: 799,
    material: 'sølv',
    image: 'https://readdy.ai/api/search-image?query=Silver%20ring%20set%20on%20soft%20pastel%20background%2C%20stackable%20rings%20jewelry%20photography%2C%20minimalist%20elegant%20design%2C%20clean%20simple%20backdrop%2C%20luxury%20jewelry%20styling%20with%20professional%20lighting&width=400&height=400&seq=201&orientation=squarish',
    affiliateLink: 'https://example.com/affiliate/3',
    inStock: true
  },
  {
    id: '11',
    name: 'Forlovelsesring Diamant',
    brand: 'Pandora',
    price: 2999,
    originalPrice: 3499,
    material: 'guld',
    image: 'https://readdy.ai/api/search-image?query=Diamond%20engagement%20ring%20on%20soft%20pastel%20background%2C%20luxury%20bridal%20jewelry%20photography%2C%20elegant%20sparkling%20design%2C%20clean%20simple%20backdrop%2C%20professional%20jewelry%20styling%20with%20soft%20lighting&width=400&height=400&seq=202&orientation=squarish',
    affiliateLink: 'https://example.com/affiliate/11',
    inStock: true
  },
  {
    id: '12',
    name: 'Guld Vielsesring',
    brand: 'Julie Sandlau',
    price: 1599,
    originalPrice: 1999,
    material: 'guld',
    image: 'https://readdy.ai/api/search-image?query=Gold%20wedding%20band%20on%20soft%20pastel%20background%2C%20classic%20bridal%20jewelry%20photography%2C%20elegant%20simple%20design%2C%20clean%20backdrop%2C%20luxury%20jewelry%20styling%20with%20professional%20lighting&width=400&height=400&seq=203&orientation=squarish',
    affiliateLink: 'https://example.com/affiliate/12',
    inStock: true
  },
  {
    id: '13',
    name: 'Statement Sølv Ring',
    brand: 'By Biel',
    price: 899,
    originalPrice: 1199,
    material: 'sølv',
    image: 'https://readdy.ai/api/search-image?query=Statement%20silver%20ring%20on%20soft%20pastel%20background%2C%20bold%20jewelry%20photography%2C%20modern%20elegant%20design%2C%20clean%20simple%20backdrop%2C%20luxury%20jewelry%20styling%20with%20professional%20lighting&width=400&height=400&seq=204&orientation=squarish',
    affiliateLink: 'https://example.com/affiliate/13',
    inStock: true
  },
  {
    id: '14',
    name: 'Rose Guld Stack Ringe',
    brand: 'Pandora',
    price: 799,
    originalPrice: 999,
    material: 'guld',
    image: 'https://readdy.ai/api/search-image?query=Rose%20gold%20stackable%20rings%20on%20soft%20pastel%20background%2C%20delicate%20jewelry%20photography%2C%20feminine%20elegant%20design%2C%20clean%20simple%20backdrop%2C%20luxury%20jewelry%20styling%20with%20professional%20lighting&width=400&height=400&seq=205&orientation=squarish',
    affiliateLink: 'https://example.com/affiliate/14',
    inStock: false
  },
  {
    id: '15',
    name: 'Vintage Sølv Signet',
    brand: 'Julie Sandlau',
    price: 1299,
    originalPrice: 1599,
    material: 'sølv',
    image: 'https://readdy.ai/api/search-image?query=Vintage%20silver%20signet%20ring%20on%20soft%20pastel%20background%2C%20classic%20jewelry%20photography%2C%20masculine%20elegant%20design%2C%20clean%20simple%20backdrop%2C%20luxury%20jewelry%20styling%20with%20professional%20lighting&width=400&height=400&seq=206&orientation=squarish',
    affiliateLink: 'https://example.com/affiliate/15',
    inStock: true
  }
];
...
export default function RingePage() {
  ...
  return (
    <>
      <Head>
        <title>Ringe | &Accessories - Smukke Smykker Online</title>
        <meta name="description" content="Fra forlovelsesringe til hverdagsringe - discover ringe til enhver finger og anledning. Find de smukkeste ringe til de bedste priser hos &Accessories." />
        <meta name="keywords" content="ringe, forlovelsesringe, giftering, hverdagsringe, sølvringe, guldringe, smykker" />
        <meta property="og:title" content="Ringe | &Accessories - Smukke Smykker Online" />
        <meta property="og:description" content="Fra forlovelsesringe til hverdagsringe - discover ringe til enhver finger og anledning." />
        <meta property="og:type" content="website" />
        <meta property="og:locale" content="da_DK" />
        <link rel="canonical" href="https://andaccessories.dk/kategori/ringe" />
      </Head>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <nav className="flex items-center space-x-2 text-sm text-gray-600">
          ...
          <i className="ri-arrow-right-s-line"></i>
          <span className="text-gray-800">Ringe</span>
        </nav>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
              Fra forlovelsesringe til hverdagsringe - discover ringe til enhver finger og anledning.
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="lg:w-3/4">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8">
              <p className="text-gray-600 mb-4 sm:mb-0">
                Viser {filteredAndSortedProducts.length} ringe
              </p>
                ...
                <div key={product.id} className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-2 border border-pink-50">
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-center space-x-2 mb-4">
                      ...
                      <span className="text-lg text-gray-400 line-through">{formatPriceWithCurrency(product.originalPrice)}</span>
                    </div>
                    
                    <a
                      href={product.inStock ? trackClick(product.affiliateLink) : '#'}
                      target="_blank"
