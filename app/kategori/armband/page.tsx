  ...
  return (
    <div className="min-h-screen bg-pink-100">
      ...
      <section className="bg-gradient-to-r from-yellow-100 to-pink-100 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl md:text-5xl font-bold text-gray-800 mb-4">Armbånd</h1>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Udforsk vores omfattende kollektion af armbånd. Find elegante armbånd, charm armbånd og meget mere.
            </p>
