    ...
    <div className="min-h-screen bg-pink-100">
      ...
      <section className="relative bg-gradient-to-r from-yellow-100 to-pink-100 py-16 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl md:text-6xl font-bold text-gray-800 mb-6">Halskæder</h1>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto mb-8">
              Udforsk vores omfattende kollektion af halskæder. Find elegante halskæder, choker og meget mere til de bedste priser.
            </p>
