...
export async function POST(request: NextRequest) {
  try {
    // Optional: Add a simple webhook secret for security
    ...
    console.log('🚀 Starting webhook-triggered database update...');
    ...
    console.log(`🎉 Webhook update completed in ${duration}ms`);
    console.log(`📊 Results: ${insertedCount} products inserted, ${batchErrors} batch errors`);

    return NextResponse.json({
      success: true,
      message: 'Webhook-triggered database update completed successfully',
      localResult,
      supabaseResult,
      duration,
